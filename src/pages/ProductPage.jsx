        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-16">
          ...
          >
              ...
              <div className="flex gap-2 flex-wrap">
                {sizes.map(size => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full font-mono text-xs border-2 transition-all ${selectedSize.label === size.label
            ...
            <motion.button
              ...
              className={`btn-primary justify-center text-base py-4 transition-all ${added ? 'bg-sage text-white' : ''
                }`}
            >
              {added ? (
                '✓ Added to Cart!'
